...
@interface SPCheckController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong) UITableView  *contentView;
@property(nonatomic,strong) NSMutableArray  *spArray;
@end

@implementation SPCheckController
...
- (void)viewDidLoad {
   ...
   [self.contentView setDelegate:self];
    ...
    self.navigationItem.title=@"我的申请单";
    ...
    [HttpRequest getWithURLString:@"http://221.130.108.114:8082/XCAPI/sqQ.ashx" parameters:dic success:^(id responseObject) {
...
//        labelPosition.font=[UIFont systemFontOfSize:10];
//        labelPhone.font=[UIFont systemFontOfSize:10];
//        
